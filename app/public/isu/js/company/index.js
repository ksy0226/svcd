...
function setDataList(dataObj, selectedPage) {
    ...
    for (var i = startIdx; i < endIdx + 1; i++) {
        ...
        addList += "							<tr onclick=location='/company/" + dataObj[i - 1]._id + "/edit'>";
        addList += "								<td>" + dataObj[i - 1].company_nm + "</td>";
        addList += "								<td class='text-center'>" + dataObj[i - 1].ceo_nm + "</td>";
        addList += "								<td>" + dataObj[i - 1].addr + "</td>";
        addList += "								<td class='text-center'>" + dataObj[i - 1].tel_no + "</td>";
        addList += "								<td class='text-center'>" + dataObj[i - 1].fax_no + "</td>";
        addList += "							</tr>";
